...
- запрещено использовать constraints (NOT NULL, UNIQUE, CHECK, FOREIGN KEY и т.п.) без явного указания пользователя, исключение составляют primary key и служебные (аудируемые) поля
