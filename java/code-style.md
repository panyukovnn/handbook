...
- [Размер методов](#размер-методов)
- [Размер файлов](#размер-файлов)
...
### Размер файлов
Файлы должны быть не длиннее 250 строк, это помогает LLM целиком загружать их в контекст и выдавать более качественные ответы
